...
const styles = StyleSheet.create({
  ...
  configInput: { flex: 1, color: colors.textPrimary, backgroundColor: colors.surfaceElevated, borderRadius: spacing.borderRadius.sm, paddingHorizontal: spacing.sm, fontSize: typography.sizes.xs },
  ...
  form: { backgroundColor: colors.surface, borderRadius: spacing.borderRadius.lg, padding: spacing.lg, borderWidth: 1, borderColor: colors.border },
  ...
  inputWrapper: { flexDirection: 'row', alignItems: 'center', minHeight: 50, backgroundColor: colors.surfaceElevated, borderRadius: spacing.borderRadius.md, borderWidth: 1, borderColor: colors.borderHighlight, paddingHorizontal: spacing.md, gap: spacing.sm },
