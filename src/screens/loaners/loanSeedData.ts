...
export const INITIAL_REAL_LOAN_AGREEMENTS: LoanAgreement[] = [
  {
  ...
  },
  {
    ...
    dueBackDateTime: new Date(Date.now() + 1800000).toISOString(), // Due in 30m
    dailyKmCap: 50,
    excessKmRate: 0.50,
    basicInsuranceExcess: 2500,
    outbound: {
  ...
  },
  {
    ...
    inbound: {
      ...
      applicableExcessBand: 'Basic Excess ($2,500)',
      applicableExcessAmount: 2500,
    },
    signatures: {
      borrowerSignatureDataUrl: 'data:image/png;base64,sample_signature',
